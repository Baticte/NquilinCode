...
public class LoginTest
{
    ...
    private static NquilinCode.Application.UseCases.User.Login.DoLogin.Login CreateUseCase(NquilinCode.Domain.Entities.User? user = null, string password = default!)
    {
        ...
        return new NquilinCode.Application.UseCases.User.Login.DoLogin.Login(validator, readRepositoryBuilder.Build(), passwordEncripter);
    }
}